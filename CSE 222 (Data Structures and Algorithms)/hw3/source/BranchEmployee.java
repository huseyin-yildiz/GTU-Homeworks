...
public class BranchEmployee extends Employee {
	...
	public void addProductStock (Product product,int size ) throws Exception {							//  O(n)
	...
	public void addProduct(Product product, int stockSize) throws Exception {									//  θ(1)
		addProduct(product);
	 ...
	 * @throws Exception */
	public void makeSale(Order order) throws Exception {										//  O(n^2)
	 ...
	 */
	public Branch getBranch() {							//  θ(1)
		return branch;
	}

	/** returns stock of the given product as parameter */
	public int getStockOfProduct(Product product) throws Exception {							//  O(n)
		return product.getStockInBranch( this.getBranch() );
	}
	
	/** informs administrator about a product with required amount */
	public void informAdmin(String ProductId, int requiredAmount) throws Exception {							//  O(n)
