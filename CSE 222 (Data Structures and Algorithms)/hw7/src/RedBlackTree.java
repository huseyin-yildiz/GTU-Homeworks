/**
 * The class for Red Black Tree
 * @param <E> The type of the class
 */
public class RedBlackTree<E extends Comparable<E>> extends BSTWithRotate<E> implements Testable<E>{
    ...
    public static class RedBlackNode<E> extends Node<E> {
        ...
        /**
         * Constructor to create a node with the given color and data
         * @param data The data item to be stored in the node
         * @param isRed if the color is red or not
         */
        public RedBlackNode(E data, boolean isRed) {
            super(data);
            this.isRed = isRed;
        }
