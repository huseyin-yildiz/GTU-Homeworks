...
public class Customer extends User {
	...
	public void orderProduct(Order order) throws Exception {
	...
	public void orderProduct(IContainer<Product> products, String contactPhone, String contactAddress) throws Exception {
		Order myOrder = new Order(products,contactPhone,contactAddress,this);
		orderProduct(myOrder);
	}
	
	/** gets all orders of the customer */
	public IContainer<Order> getMyOrders(){ return myOrders; } 
