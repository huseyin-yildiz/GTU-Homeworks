...
public abstract class Product implements Identifiable  {
	...
	public Product( String modelName, Color color, float price) throws Exception {
		super();
		this.id = generateId();
	...
	public Product( String modelName, float price) throws Exception {
	...
	private void setUpStocks() throws Exception {
	 ...
	 */
	public int getStockInBranch(Branch branch) throws Exception {					
	...
	public int getAllStockSize() throws Exception{
		int size = 0;
		Iterator<Branch> branches = repository.getBranches().iterator();
		while(branches.hasNext()) {
			Branch branch = branches.next();
	 ...
	 */
	public void updateStock(String branchName,int stock) throws Exception {
	...
	public void addStock(String branchName, int stock) throws Exception {
